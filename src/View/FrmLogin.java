...
//                + ""+ (new UsuarioDAO().findByLogin("admin")).getCriacao());    
    ...
    private void initComponents() {
        ...
        btnEntrar.setBounds(200, 240, 120, 23);
        ...
        pfdSenha.setBounds(200, 210, 120, 20);

        lblLogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assets/Images/essential-drinks-logo.png"))); // NOI18N
        jPanel1.add(lblLogo);
        lblLogo.setBounds(180, -10, 240, 200);

        lblFundo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assets/Images/login_background-opt2.jpg"))); // NOI18N
        lblFundo.setOpaque(true);
        jPanel1.add(lblFundo);
        lblFundo.setBounds(0, -180, 510, 690);
    ...
    private void btnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntrarActionPerformed
        ...
        if (usuarioBusca != null) {
            ...
            JOptionPane.showMessageDialog(null, "Verifique suas credenciais!", "ERRO AO EFETUAR LOGIN",
